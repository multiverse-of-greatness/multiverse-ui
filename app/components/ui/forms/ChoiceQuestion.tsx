      ...
      <div className="mt-2 flex flex-col">
        {options.map((option) => (
          <div
            ...
            key={option.value}
          >
            <div className="h-4 w-4 self-center rounded-full border-4 border-slate-50 bg-slate-50 group-has-[:checked]:border-2 group-has-[:checked]:bg-indigo-600 transition-all" />
            <input
