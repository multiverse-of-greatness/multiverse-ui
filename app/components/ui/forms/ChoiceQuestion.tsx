      ...
      <div className="mt-2 flex flex-col">
        {options.map((option) => (
          <div
            ...
            key={option.value}
          >
            <div className="h-4 w-4 self-center rounded-full border border-zinc-400 dark:border-slate-50 bg-slate-50 transition-all group-has-[:checked]:border-2 group-has-[:checked]:bg-indigo-600" />
            <input
